...
public interface PayStation {
    ...
    */ 
    ...
    /**
     * setPayRate will be the method that helps the user change the pay rate
     */
    public void setPayRate(PayRate payRate);

    /**
     * Changes pay rates mid-use so the user won't have the calculations of the different rates in one receipt/purchase
     */
    public void updateTimeBought();
}
